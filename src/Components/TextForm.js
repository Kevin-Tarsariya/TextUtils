...
export default function TextForm(props) {
  ...
  return (
    <div className={`container my-4 text-${props.mode === 'light' ? 'dark' : 'light'}`}>
      <h1 className={`mb-4 text-center display-3 text-${props.mode === 'light' ? 'dark' : 'dark'}`}>{props.heading}</h1>
      ...
      <div className="d-flex flex-wrap gap-2 mb-3">
        ...
        <button className="btn btn-primary" onClick={handleRemovePunctuation}><FaRegLightbulb /> Remove Punctuation</button>
